  ...
  const PYLINAC_CATALOG = [
    ...
    },
    {
      ...
      params: [
        ...
        { key: "machine_scale", label: "Escala da máquina", type: "select", options: ["IEC61217", "VARIAN_STANDARD", "ELEKTA_IEC"], default: "IEC61217" },
    ...
    },
    {
      ...
      params: [
        { key: "protocol", label: "Protocolo", type: "select", options: ["VARIAN", "ELEKTA", "SIEMENS", "NONE"], default: "VARIAN" },
        { key: "invert", label: "Inverter imagem", type: "checkbox", default: false },
