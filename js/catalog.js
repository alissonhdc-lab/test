  ...
  const PYLINAC_CATALOG = [
    ...
    },
    {
      ...
      metrics: [
        { key: "dicom_gantry_angle_deg", label: "Ângulo do Gantry", unit: "°", tolType: "info", plottable: false },
        { key: "dicom_collimator_angle_deg", label: "Ângulo do Colimador", unit: "°", tolType: "info", plottable: false },
        { key: "field_size_x_mm", label: "Tamanho de campo (X / crossplane)", unit: "mm", tolType: "info" },
        { key: "field_size_y_mm", label: "Tamanho de campo (Y / inplane)", unit: "mm", tolType: "info" },
        ...
        { key: "field_bb_offset_x_mm", label: "Desvio campo → BB / Luz×Rad (X)", unit: "mm", tolType: "max", tol: 1.0 },
        { key: "field_bb_offset_y_mm", label: "Desvio campo → BB / Luz×Rad (Y)", unit: "mm", tolType: "max", tol: 1.0 },
